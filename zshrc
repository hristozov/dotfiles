...
alias emerge-upd='sudo schedtool -D -e emerge --keep-going -DuN world'
alias reboot='sudo reboot'
alias halt='sudo halt'
alias acpitool='sudo acpitool'
alias make='schedtool -D -e make -j4'
...
alias la='ls -al'
alias v='vi'
#alias vlc='schedtool -I -e vlc'
alias s='sudo'
alias t='tmux'
alias ta='tmux attach'
alias revdep='sudo schedtool -D -e revdep-rebuild'
